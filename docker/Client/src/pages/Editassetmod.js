        ...
        <div className="w-full min-h-screen -ml-8">
            <Topnav>
                ...
                <form>
                    ...
                    <div className="py-5 px-10">
                        <h2 className="pb-5 font-bold">Cost</h2>
                        <p contentEditable="true" className="bg-white pl-4 bg-dark rounded-md drop-shadow-lg w-60 py-1">50000</p>
                    </div> 
                    <div className="py-5 px-10">
                        <h2 className="pb-5 font-bold">Working Condition</h2>
                        <p contentEditable="true" className="bg-white pl-4 bg-dark rounded-md drop-shadow-lg w-60 py-1">Not Available</p>
                    </div>
